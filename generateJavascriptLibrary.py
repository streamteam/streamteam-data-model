...
f = open("src/main/javascript/streamteam-data-model-lib-1.2.0.js", "w")
...
f.write("jsFileLocation = jsFileLocation.replace('streamteam-data-model-lib-1.2.0.js', '');   // the js folder path\n\n")
